...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.joker.service.impl.PasswordTokenManager#generateRecoveryToken(com.joker.model.User)
     */
    @Override
    ...
    /**
     * @see com.joker.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.joker.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.joker.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
